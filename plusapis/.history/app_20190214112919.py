...
def postmantenimientos():
    ...
    try:
        ...
        cursor = conn.cursor()
        datos = request.json
        sql = sqls.post_sql_mantenimientos.format(datos['numeroorden'],datos['numerobastidor'],datos['tipocomercial'],datos['codigotipocomercial'],datos['ldm'],datos['ldc'],datos['matricula'],datos['kilometraje'],datos['aniomodelo'],datos['matriculacion'],datos['asesorservicio'],fechaactual,
        datos['lugar'],datos['b1r1'],datos['b1r2'],datos['b1r3'],datos['b1r4'],datos['b2r1'],datos['b2r2'],datos['b3r1'],datos['b3r2'],datos['b4r1'],datos['b4r2'],datos['b5r1'],datos['b5r2'],datos['c1'],datos['c2'],datos['c3'],datos['c4'],datos['c5'],datos['c6'],datos['c7'],datos['c8'],datos['c9'],datos['c10'],datos['c11'],datos['c12'])
        cursor.execute(sql)
        cursor.close()
        conn.commit()
        conn.close()
